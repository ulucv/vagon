...
locals {
  ...
  #domain_name      = "${var.env}.intra.${var.domain_name}"
  argocd_host      = "argocd-${var.region}.${var.env}.intra.${var.domain_name}"
  ...
  addons_metadata = merge(
    ...
    },
    {
      ...
      external_dns_domain_filters = "[${var.env}.${var.domain_name}]"
    },
    {
...
#  count        = 1
#  name         = "${var.env}.intra.${var.domain_name}"
#  private_zone = true
#}
